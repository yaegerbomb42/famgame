/** All games the server can run — keep in sync with `GameType` / RoomManager.selectGame */
export const GAME_CATALOG: { id: string; name: string; icon: string; minPlayers?: number }[] = [
